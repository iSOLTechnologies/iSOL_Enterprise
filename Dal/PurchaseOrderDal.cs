...
namespace iSOL_Enterprise.Dal
{
    public class PurchaseOrderDal
    {
        ...
        public List<SalesQuotation_MasterModels> GetPurchaseQuotationData(int cardcode)
        {
                ...
                try
                {
                    ...
                    if (model.ListItems != null)
                    {
                        ...
                        foreach (var item in model.ListItems)
                        {
                            ...
                            string RowQueryItem = @"insert into POR1(Id,LineNum,ItemCode,Quantity,DiscPrcnt,VatGroup , UomCode ,CountryOrg)
                                              values(" + Id + ","
                                                + LineNo + ",'"
                                                + item.ItemCode + "',"
                                                + item.QTY + ","
                    ...
                    else if (model.ListService != null)
                    {
                        ...
                        {
                            //int QUT1Id = CommonDal.getPrimaryKey(tran, "QUT1");
                            string RowQueryService = @"insert into POR1(Id,LineNum,Dscription,AcctCode,VatGroup)
                                                  values(" + Id + ","
                                                    + LineNo + ",'"
                                                    + item.Dscription + "','"
                                                    + item.AcctCode + "','"
