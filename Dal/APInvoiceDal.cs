                ...
                try
                {
                    ...
                    if (model.ListItems != null)
                    {
                        ...
                        foreach (var item in model.ListItems)
                        {
                            ...
                            string RowQueryItem = @"insert into PCH1(Id,LineNum,BaseRef,BaseEntry,BaseLine,BaseQty,BaseType,ItemName,Price,LineTotal,OpenQty,ItemCode,Quantity,DiscPrcnt,VatGroup , UomCode,UomEntry ,CountryOrg)
                                              values(" + Id + ","
                                             + LineNo + ",'"
                                             + item.BaseRef + "',"
                                             + item.BaseEntry + ","
