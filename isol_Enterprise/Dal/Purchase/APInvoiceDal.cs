                        ...
                        if (model.ListItems != null)
                        {
                            ...
                            foreach (var item in model.ListItems)
                            {
                                ...
                                else
                                {
                                    ...
                                    string RowQueryItem = @"insert into PCH1(Id,LineNum,WhsCode,ItemName,Price,LineTotal,OpenQty,ItemCode,Quantity,DiscPrcnt,VatGroup , UomCode,UomEntry ,CountryOrg)
                                              values(" + model.ID + ","
                                                     + LineNo + ",'"
                                                     + item.Warehouse + "','"                                                     
                                                     + item.ItemName + "',"
