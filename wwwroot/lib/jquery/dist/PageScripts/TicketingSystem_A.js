$(document).ready(function () {
    ...
    $('#LookupThead tbody tr').each(function (index, item) {
        ...
        //}
        //$(this).find("#Status").val(data[index].guid);
        //$(this).find("#TicketCode").val(data[index].ticketCode);

        //$(this).find("#Project").val(data[index].project);
...
$(document).on('click', '.OperationBtns', function (e) {
    ...
    if (Operation == "Create") {
        window.location.href = '/TicketingSystem/AddTicket_A?Source=' + $('#PageGuid').val();
    ...
    if (Operation == "Edit") {
        ...
        window.location.href = '/TicketingSystem/AddTicket_A?Source=' + $('#PageGuid').val() + '&Id=' + rowData.id;
